...
const partners = [
  {
    ...
    image: devanshi,
    expertise: [
      { icon: ShieldCheck, text: "Corporate Compliance" },
      { icon: FileCheck, text: "ROC Compliance" },
      { icon: Building2, text: "Company Law & Corporate Governance" },
      { icon: FileText, text: "Commercial Drafting" },
      { icon: Briefcase, text: "Secretarial & Regulatory Advisory" },
    ],
  },

  {
    ...
    image: mudrika,
    expertise: [
      { icon: Scale, text: "Litigation" },
      { icon: Handshake, text: "Dispute Resolution" },
      { icon: Landmark, text: "Court Representation" },
      { icon: Scale, text: "DRT & DRAT Matters" },
      { icon: FileText, text: "SARFAESI Act Matters" },
      { icon: Building2, text: "RERA Litigation & Advisory" },
      { icon: FileText, text: "Waqf Law Matters" },
      { icon: Lightbulb, text: "Legal Strategy" },
    ],
  },

  {
    ...
    expertise: [
      ...
      { icon: FileText, text: "Commercial & Cross-Border Contracts" },
      { icon: ShieldCheck, text: "Regulatory & Statutory Compliance" },
      { icon: Building2, text: "Corporate Governance & Legal Risk Management" },
      { icon: Handshake, text: "Dispute Resolution & Litigation Strategy" },
      { icon: Landmark, text: "Banking, RERA & SARFAESI Matters" },
      { icon: FileCheck, text: "Legal Due Diligence & Title Verification" },
      { icon: Scale, text: "Litigation & Regulatory Advisory" },
    ],
  },
];
    ...
    >
      <Container>
        ...
        >
          ...
          >
            Leadership That Brings Legal Expertise Together
          </h2>

          <p className="mt-6 text-lg leading-8 text-[#4B5563]">
            Our founding partners bring together diverse legal expertise,
            industry experience, and strategic insight to provide practical
    ...
    >
      ...
      <div className="p-6">
        <div className="flex flex-col items-center">
          ...
          <h3
            className="mt-6 text-2xl font-semibold text-[#0F172A] text-center"
            style={{ fontFamily: '"Cormorant Garamond", serif' }}
          >
            {partner.name}
          </h3>

          <p className="mt-2 text-center font-medium text-[#B08D57]">
            {partner.role}
          </p>

          <div className="mt-6 h-px w-20 bg-[#B08D57]" />
        </div>
